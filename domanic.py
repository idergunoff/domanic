...
ui.checkBox_interp_resourse.stateChanged.connect(draw_interp_resourse)
...
ui.pushButton_add_param_ml_corr.clicked.connect(add_param_ml_corr)
...
ui.pushButton_add_trying.clicked.connect(add_new_trying)
ui.pushButton_skip_sample.clicked.connect(add_sample_to_skip)
ui.pushButton_use_linking.clicked.connect(use_trying_linking)
ui.pushButton_cansel_used_linking.clicked.connect(cansel_used_linking)
...
ui.pushButton_test_linking.clicked.connect(test_linking)
